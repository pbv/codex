<form id="codeform" method="post" action="${post_action}">
  ...
  <p><input type="hidden" name="path" value="${editPath}"/>
  <p><input type="submit" value="${submitLabel}" onClick="submitForm()"/>
  <input type="button" value="${cancelLabel}" onClick="window.location = '${next_url}';"/>
</form>
