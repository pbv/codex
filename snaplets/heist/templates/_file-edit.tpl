...
<apply template="_base">
  ...
  <apply template="_browse">
    <ifAdmin>
      <li><a class="admin" title="Voltar ao diretório anterior"
 ...
 <h1><file-path/></h1>
  ...
  <if-text-file>
    <form id="editform" method="POST" action="${file-url}">
      ...
      <p><input type="submit" value="Gravar alterações"/> &emsp;
	<button type="button" onclick="window.open('${page-url}')">Visualizar</button>
      </p>
    </form>
